...
* The reviewed inventory currently contains 532 repository and 208 integration test methods. The positive QEMU configuration matrix has 9 distinct configurations: 8/16/64/128/256/512/4096 MiB, `max` CPU, and the low-32/high-RAM layout.
