...
* The complete suite currently contains 110 repository and 155 integration test methods (147 non-shell + 8 shell). The positive QEMU configuration matrix has 9 distinct configurations: 8/16/64/128/256/512/4096 MiB, `max` CPU, and the low-32/high-RAM layout.
