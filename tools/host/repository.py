...
REQUIRED_DIRECTORIES = (
    ...
    "tools/rynorlang/runtime", "tools/rynorlang/std",
    ...
    "tests/fixtures/rynorlang/modules/good",
    "tests/fixtures/rynorlang/modules/bad",
    "tests/fixtures/rynorlang/conformance/good",
    "tests/fixtures/rynorlang/conformance/bad",
    "tests/fixtures/rynorlang/conformance/projects",
...
REQUIRED_FILES = (
    ...
    "docs/design/rynorlang-modules.md",
    "tools/rynorlang/module.py",
    "tools/rynorlang/std/math.rl",
