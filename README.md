...
records. The reviewed inventory contains 571 repository and 243 integration test
methods (Stage 18d Slices A/B: input path + syscall substrate). The build command checks exact per-module participation before discovery. Exact commands and evidence are in the
